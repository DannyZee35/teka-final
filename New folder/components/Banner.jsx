...
const Banner = ({heading,subHeading}) => {
  return (
    <div className='max-w-[1300px]   m-auto bg-[#7E62EF] sm:bg-transparent  sm:bg-contain bg-cover bg-no-repeat mt-20 p-14 relative ' style={{backgroundImage: 'url("/gradient.png")'}}>
