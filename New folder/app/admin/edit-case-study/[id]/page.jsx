...
const EditCaseStudy = ({ params }) => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await axios.put(`/api/edit-case-study/${params.id}`, formData, {
        headers: {
          "Content-Type": "multipart/form-data",
        },
      });

      console.log("Case Study post updated:", response.data);
      ...
      console.error("Error updating Case Study post:", error);
      toast.error("An error occurred while updating the Case Study post.");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="w-[800px]">
      <Toaster />
      <h1 className="font-bold mb-5 text-4xl">Edit Case Study</h1>
