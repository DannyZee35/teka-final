...
const Page = () => {
  ...
  return (
    <div className="bg-black  relative  flex items-start justify-center gap-20 p-20">
      <div className="bgImage">
      </div>
      <div className="mt-14 z-50">
        <h1 className="text-white text-5xl font-bold  ">Request a Demo</h1>
      ...
      {!formSubmitted ? (
        <form
          className="space-y-6 z-50  border bg-white text-black p-10  rounded-xl"
        ...
        >
          ...
          <div>
            <label htmlFor="annualSales" className="block text-sm font-medium ">
              Whats your total annual revenue?
            </label>
            <select
              id="annualSales"
              name="annualSales"
          ...
          <div>
            ...
            >
              ...
              <option value="$1,000,001-$5,000,000">
                $1,000,001-$5,000,000
              </option>
              <option value="$5,000,001-$10,000,000">
                $5,000,001-$10,000,000
              </option>
              <option value="More than $10,000,000">
